...
def _add_event_to_google_calendar(series_name: str, start_time: datetime.datetime, end_time: datetime.datetime,
                                  series_description: str):
    google_calendar = my_google_calendar.GoogleCalendar()
    google_calendar.create_event(summary=series_name, description=series_description, start_time=start_time,
                                 end_time=end_time, time_zone=TI)
    return None
